                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="devit-card-custom">
                                                                    ...
                                                                    {/* <labe className="formLable">Select section image</labe> */}
                                                                        <input type="file" className="form-control" placeholder="Select image" onchange="document.getElementById('prepend-big-btn').value = this.value;" />
                                                                    </div>
                                                                    <div className="form-group">
                                                                        {/* <labe className="formLable">Select carousel image</labe> */}
