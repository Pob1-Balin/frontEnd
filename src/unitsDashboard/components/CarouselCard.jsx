               ...
               <Carousel>
                 <Carousel.Item>
                   <div className="carousel_card carousel_card_one" style={{background: "white"}}>
                     <div style={{textAlign: 'center'}}>
                         <img className="carousel_card_image" src={`/api/v1/images/${props.image_one}`} width='50%' height='55%'/>
                     </div>
                 ...
                 <Carousel.Item>
                   <div className="carousel_card carousel_card_two" style={{background: "white"}}>
                     <div style={{textAlign: 'center'}}>
                         <img className="carousel_card_image" src={`/api/v1/images/${props.image_two}`} width='50%' height='55%'/>
                     </div>
                     <div style={{marginLeft: '2rem', marginRight: '2rem'}}>
                 ...
                 <Carousel.Item>
                   <div className="carousel_card carousel_card_three" style={{background: "white"}}>
                     <div style={{textAlign: 'center'}}>
                     <img className="carousel_card_image" src={`/api/v1/images/${props.image_three}`} width='50%' height='55%'/>
                     </div>
                     <div style={{marginLeft: '2rem', marginRight: '2rem'}}>
