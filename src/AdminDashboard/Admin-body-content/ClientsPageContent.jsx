                                    ...
                                    <div class="asset-inner">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                                    <button class="pd-setting-ed"><i class="fa fa-stop-circle-o" aria-hidden="true"></i></button>
                                                    <button class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
