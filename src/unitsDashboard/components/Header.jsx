        ...
        <>
             <div style={{marginLeft:"-1.5rem", marginRight:"-1.5rem", height:"2rem", marginTop:"-6.7rem"}} className='Unit-header-card'>
                <div className='header-link' style={{background:"transparent"}}>
                    <Link className='header-link-link' to='/adminunitcontent' state={{id: props.id, title: props.title, content:props.unit_content, image:props.image}} style={{textDecoration:"none", paddingTop:"1rem"}}>
