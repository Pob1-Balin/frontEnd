                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form data-aos="zoom-out-right" data-aos-offset="100" >
                                    <div className="form-group">
                                        ...
                                        <input style={{height:'2.5rem'}} className="form-control" type="password" name="password" placeholder="Enter password" />
                                    </div>
                                    <div className="form-group">
                                        <div style={{marginBottom: "-12px"}} className="FormLable"><p>Confirm password*</p></div>
                                        <input style={{height:'2.5rem'}} className="form-control" type="password" name="password" placeholder="Enter confirm password" />
                                    </div>
