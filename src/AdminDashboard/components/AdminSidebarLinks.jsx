      ...
      <>
            <div id="mySidebar" className="side_bar border-end bg-white" style={{width:'18rem'}}>
                <div className="list-group list-group-flush">
                    ...
                    <div className="list-group list-group-flush">
                         {data.map((link) => <NavLink style={{textDecoration:"none"}} to={"/"+link.component} activeStyle={{ color: 'red' }} className="unit-nave fw-bold list-group-item-action list-group-item-light p-3"><NotesIcon className='mr-4'/>{link.Title}</NavLink> )}
                    </div>
                </div>
            </div>
      </>
