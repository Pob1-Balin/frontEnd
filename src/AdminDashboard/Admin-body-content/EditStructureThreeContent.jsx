...
function EditStructureThreeContent() {
    ...
    const arr = unitId.content[unitId.index];    
    const structure_details1 = arr[arr.length - 1];
    var new_arr = [];

    for (let i = 0; i < arr.length - 1; i++) {
        new_arr = [...new_arr, arr[i]];
    }
    const [newUnitContent, setNewUnitContent] = useState(new_arr);
    ...
    const [pageTitle, setPageTitle] = useState(structure_details1.pageTitle);
    ...
    const handleSubmit = e =>{
        ...
        if(pageTitle != ""){
            ...
            unitId.content.splice(unitId.index, 1, [...newUnitContent, structure_info])
            const new_content = unitId.content;    
            submitUnitData({
    ...
    return (
        <>
            <main className="px-md-4" >
                <Header unit_content={unitId.content} id={unitContent.id} title={unitContent.title} image={unitContent.image}  module_name={unitId.module_name} module_title={unitId.module_title} header_title="Créer du contenu" />
                                                                    ...
                                                                    <div className="add-structure-headings"><p className="main-heading">Ajouter des structures</p></div>
                                                                        ...
                                                                        <div className="col-lg-6 col-md-12">
                                                                            ...
                                                                            <form style={{margin:"0rem"}}>
                                                                                <div className="input-group" style={{marginBottom:"1.7rem", marginTop:"1rem"}}>
                                                                                    <input type="text" className="form-control correct-input input" placeholder="Ajouter des réponses" style={{color:"#4ab2cc"}} name="pageTitle" value={pageTitle} onChange={handlePageTitle}  required/>
                                                                                </div>
                                                                            </form>
                                                                        </div>
