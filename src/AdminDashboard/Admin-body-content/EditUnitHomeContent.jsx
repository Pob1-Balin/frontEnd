...
function EditUnitHomeContent() {
    ...
    const [inputs, setInputs] = useState({
        sidebar_name: "Home",
        page_title: units_content.page_title,
        video: "",
    });
   ...
   var unitsDataContent = [{}]
    ...
    const handleSubmit = e =>{
        ...
        const unit_home_content = inputs;
        submitUnitData({
            unit_home_content,
        });
    ...
    return (
        <>
            <main className="px-md-4" >
                <Header header_title="Edit unit home content" />
...
export default EditUnitHomeContent;
