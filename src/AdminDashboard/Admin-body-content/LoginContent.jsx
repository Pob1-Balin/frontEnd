                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="product-sales-chart login-card-border">
                                         <div class="portlet-title">
                                             <p class="text-center Login-name">LOGIN</p>
                                         </div>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="devit-card-custom">
                                                                ...
                                                                <div style={{marginTop: '1.3rem'}} class="form-group">
                                                                    <a style={{height:'2.5rem', background:'#4ab2cc', color:'white', width:"100%", borderRadius:".4rem"}} href="#!" class="btn waves-effect waves-light submitBtn">SUBMIT</a>
                                                                </div>
                                                                ...
                                                                <div class="row text-center mt-2 mb-4" style={{marginTop:"-.5rem"}}>
                                                                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                         <p style={{fontSize:".9rem"}}>In need of an Account? <span><a href="#">Sign Up</a></span></p>
                                                                     </div>
                                                                </div>
